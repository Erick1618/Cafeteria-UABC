...
$sql = $connection->prepare("SELECT * FROM comida WHERE tipo_platillo = ". $tipo ."");
$result = $sql->execute();
	...
	if(isset($_POST["operation"]))
	{
		if($_POST["operation"] == "Add")
		{
			...
			$statement = $connection->prepare("
				INSERT INTO comida (nombre_platillo, descripcion_platillo, foto_platillo, tipo_platillo) 
