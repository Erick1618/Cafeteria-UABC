...
<body>
    ...
    <div class="page">
        ...
        <section class="section section-lg bg-default">
            <div class="container">
                <h3 class="oh-desktop"><span class="d-inline-block wow slideInUp">Desayuno</span></h3>
                <?php
                    $sql = "SELECT precio FROM menu_rotativo WHERE menu = 'desayuno'";
                    $result = mysqli_query($conexion, $sql);
                    $row = mysqli_fetch_array($result);
                    $precio = $row['precio'];

                    echo '<h3 class="oh-desktop"><span class="d-inline-block wow slideInUp">$' . $precio . '</span></h3>';
                ...
                <div>
                    ...
                    <div class="text-center">
                        <h3 class="oh-desktop"><span class="d-inline-block wow slideInUp"> Platos fuertes </span></h3>
                    </div>
                    <div class="row">
                        <?php
                            $sql = "SELECT nombre_platillo, descripcion_platillo, foto_platillo FROM desayuno WHERE tipo_platillo = 0";
                            $result = mysqli_query($conexion, $sql);
                                ...
                                echo '
                                    ...
                                    <div class="col-12">
                                        <article class="product wow fadeInLeft" data-wow-delay=".15s">
                                            <h4 class="product-title">No hay platos fuertes disponibles<br></h6> 
                                        </article>
                                    </div>
                                ';
                            }
                                    ...
                                    <div class="col-6">
                                        <article class="product wow fadeInLeft" data-wow-delay=".15s">
                                            <h4 class="product-title">
                                                ...
                                                <div class="product-figure"><img src="./../../Empleados/menu_rotativo_desayuno/upload/' . $row["foto_platillo"] . '" alt="" width="161" height="162" />
                                                </div>
                                                <div class="product-price-wrap">
                                                    <div class="product-price">' . $row["descripcion_platillo"] . '</div>
                                                </div>
                                                <br>
                                                <div class="product-button-sm">
                                                    <div class="button-wrap"><a class="button button-xs button-secondary button-winona" href="#"> SELECCIONAR </a></div>
                                                </div>
                                        </article>
                                    </div>
                                ';
                    ...
                    <!-- GUARNICION -->
                    <div class="text-center">
                        <h3 class="oh-desktop"><span class="d-inline-block wow slideInUp"> guarniciones </span></h3>
                    </div>
                    <div class="row">
                        <?php
                            $sql = "SELECT nombre_platillo, descripcion_platillo, foto_platillo FROM desayuno WHERE tipo_platillo = 1";
                            $result = mysqli_query($conexion, $sql);
                            $numero = $result->num_rows;
                            ...
                            if ($numero == 0) {
                                echo '
                                    ...
                                    <div class="col-12">
                                        <article class="product wow fadeInLeft" data-wow-delay=".15s">
                                            <h4 class="product-title">No hay guarniciones disponibles<br></h6> 
                                        </article>
                                    </div>
                                ';
                            }
                    ...
                    <!-- ENTRADA -->
                    <div class="text-center">
                        <h3 class="oh-desktop"><span class="d-inline-block wow slideInUp"> Entradas </span></h3>
                    </div>
                    <div class="row">
                        <?php
                            $sql = "SELECT nombre_platillo, descripcion_platillo, foto_platillo FROM desayuno WHERE tipo_platillo = 2";
                            $result = mysqli_query($conexion, $sql);
                            $numero = $result->num_rows;
                            ...
                            if ($numero == 0) {
                                echo '
                                    ...
                                    <div class="col-12">
                                        <article class="product wow fadeInLeft" data-wow-delay=".15s">
                                            <h4 class="product-title">No hay entradas disponibles<br></h6> 
                                        </article>
                                    </div>
                                ';
                            }
                    ...
                    <!-- BEBIDA DEL DIA -->
                    <div class="text-center">
                        <h3 class="oh-desktop"><span class="d-inline-block wow slideInUp"> Bebidas del dia </span></h3>
                    </div>
                    <div class="row">
                        <?php
                            $sql = "SELECT nombre_platillo, descripcion_platillo, foto_platillo FROM desayuno WHERE tipo_platillo = 3";
                            $result = mysqli_query($conexion, $sql);
                            $numero = $result->num_rows;
                            ...
                            if ($numero == 0) {
                                echo '
                                    ...
                                    <div class="col-12">
                                        <article class="product wow fadeInLeft" data-wow-delay=".15s">
                                            <h4 class="product-title">No hay bebidas del dia disponibles<br></h6> 
                                        </article>
                                    </div>
                                ';
                            }
