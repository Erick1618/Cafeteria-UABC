...
<body>
    ...
    <div class="page">
        ...
        <section class="section section-lg bg-default">
            <div class="container">
                <h3 class="oh-desktop"><span class="d-inline-block wow slideInUp"> Desayunos </span></h3>
                ...
                <div>
                    <div class="row">
                        <?php
                            $sql = "SELECT * FROM platillos WHERE categoria_platillo = 4 && mostrar_platillo = 1";
                                ...
                                echo '
                                    ...
                                    <div class="col-12">
                                        <article class="product wow fadeInLeft" data-wow-delay=".15s">
                                            <h4 class="product-title">No hay desayunos disponibles<br></h6> 
                                        </article>
                                    </div>
                                ';
                            }
