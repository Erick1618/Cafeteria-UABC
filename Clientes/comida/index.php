...
<body>
    ...
    <div class="page">
        ...
        <section class="section section-lg bg-default">
            <div class="container">
                <h3 class="oh-desktop"><span class="d-inline-block wow slideInUp">Comida</span></h3>
                <?php
                    $sql = "SELECT precio FROM menu_rotativo WHERE menu = 'comida'";
                ...
                <div>
                    ...
                    <div class="row">
                        <?php
                            $sql = "SELECT nombre_platillo, descripcion_platillo, foto_platillo FROM comida WHERE tipo_platillo = 0";
                            $result = mysqli_query($conexion, $sql);
                                    ...
                                    <div class="col-6">
                                        <article class="product wow fadeInLeft" data-wow-delay=".15s">
                                            <h4 class="product-title">
                                                ...
                                                <div class="product-figure"><img src="./../../Empleados/menu_rotativo_comida/upload/' . $row["foto_platillo"] . '" alt="" width="161" height="162" />
                                                </div>
                    ...
                    <div class="row">
                        <?php
                            $sql = "SELECT nombre_platillo, descripcion_platillo, foto_platillo FROM comida WHERE tipo_platillo = 1";
                            $result = mysqli_query($conexion, $sql);
                            $numero = $result->num_rows;
                    ...
                    <div class="row">
                        <?php
                            $sql = "SELECT nombre_platillo, descripcion_platillo, foto_platillo FROM comida WHERE tipo_platillo = 2";
                            $result = mysqli_query($conexion, $sql);
                            $numero = $result->num_rows;
                    ...
                    <div class="row">
                        <?php
                            $sql = "SELECT nombre_platillo, descripcion_platillo, foto_platillo FROM comida WHERE tipo_platillo = 3";
                            $result = mysqli_query($conexion, $sql);
                            $numero = $result->num_rows;
