...
<body>
    ...
    <div class="page">
                            ...
                            <div class="rd-navbar-right rd-navbar-nav-wrap">
                                ...
                                <div class="rd-navbar-main">
                                    ...
                                    <ul class="rd-navbar-nav">
                                        ...
                                        <li class="rd-nav-item active"><a class="rd-nav-link" href="#">Pedidos</a>
                                        </li>
        ...
        <section class="section section-lg bg-default">
            <div class="container">
                <h3 class="oh-desktop"><span class="d-inline-block wow slideInUp"> Pedidos </span></h3>

                <?php if (empty($_SESSION['carrito'])){ ?>
                    <div class="alert alert-success">
                        <strong>¡No haz hecho ningun pedido!</strong>
                    </div>
                <?php } else { ?>

                    <div class="table table-responsive-sm table-sm">
                            ...
                            <tbody>
                                ...
                                <?php foreach($_SESSION['carrito'] as $indice => $producto){ ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"> $<?php echo $producto['CANTIDAD'] * $producto['PRECIO'] ?> </td>

                                        <td> 
                                            <form action="" method="POST">
                                                <input type="hidden" name="id" id="id" value="<?php echo $producto['ID']; ?>">

                                                <button class="btn btn-warning btn-sm" name="btnAccion" value="Eliminar" type="submit"> Quitar </button> 
                                            </form>
                                        </td>
                                    </tr>
                        ...
                        <table>
                            <tr>
                                ...
                                <td width="50%" align="right"><h3>$<?php echo number_format($total, 2); ?></h3></td>
                            </tr>
                                ...
                                <td colspan="2" align="right">
                                    <form action="pagar.php" method="POST">
                                        <div class="d-grid gap-2">
                                            <button class="btn btn-primary btn-sm btn-block" type="submit" name="btnAccion" value="proceder">
                                                Pagar (PayPal)  <i class="fab fa-paypal"></i>
                                            </button>
                                        </div>
                                    </form>
                                </td>
